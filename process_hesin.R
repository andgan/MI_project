...
######## DIABETES #########
# Define type two diabetes from self-reported
dm_t2dm_sr_ni <- NA
...
meds_any_sr_ni_ts <- NA #this single variable captures all 3 categories of DM medications AND the insulin TS
...
v <- c(1140861958,1140888648, 1140888594, 1141146234,1141192410, 1141192736,1140861868,1140861954 )
