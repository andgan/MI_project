...
write.table(numb, file = 'association_prs.tsv', sep = "\t", row.names = TRUE, col.names = TRUE)
...
write.table(resdf, file = 'association_analysis.tsv', sep = "\t", row.names = TRUE, col.names = TRUE)
...
write.table(sub.pop.table, file = 'association_subset_interaction.tsv', sep = "\t", row.names = TRUE, col.names = TRUE)
...
write.table(cindex.comorb.nocomorb, file = 'association_cont_prs.tsv', sep = "\t", row.names = TRUE, col.names = TRUE)
...
write.table(cindex.dich.prs, file = 'association_dich_prs.tsv', sep = "\t", row.names = TRUE, col.names = TRUE)
...
write.table(pop.table, file = 'association_icd_sens_spec.tsv', sep = "\t", row.names = TRUE, col.names = TRUE)
...
write.table(cindex_dich, file = 'association_prs_auc.tsv', sep = "\t", row.names = TRUE, col.names = TRUE)
...
write.table(roc.table, file = 'association_prs_roc.tsv', sep = "\t", row.names = TRUE, col.names = TRUE)